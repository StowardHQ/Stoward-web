  ...
  return (
    <div class="bg-brand-page text-brand-textPrimary relative flex min-h-screen w-full flex-col items-center justify-center overflow-x-hidden font-sans">
      <Show
        ...
        <Show
          when={!server.error && server()}
          fallback={
            <main class="relative z-10 mx-auto flex w-full max-w-xl flex-col items-center justify-center px-4 text-center">
              <div class="bg-brand-orange/10 text-brand-orange mb-4 rounded-full p-4">
                <BiSolidCompass size={40} />
              </div>
              <h1 class="text-brand-textPrimary mb-2 text-2xl font-black tracking-tight sm:text-3xl">
                Server Not Found
              </h1>
              <p class="text-brand-textSecondary mb-8 max-w-sm text-sm leading-relaxed">
                Oops! The server you are looking for doesn't exist, or has been removed from
                Stoward.
              </p>
              <A
                href="/"
